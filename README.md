# YAML to Kotlin Gradle Plugin ![GitHub license](https://img.shields.io/github/license/noodlemind/yaml-to-kotlin) ![Build Status](https://img.shields.io/github/workflow/status/noodlemind/yaml-to-kotlin/gradle-build.yml) ![Gradle Plugin Portal](https://img.shields.io/maven-metadata/v?metadataUrl=https%3A%2F%2Fplugins.gradle.org%2Fm2%2Fio%2Fgithub%2Fnoodlemind%2Fyaml-to-kotlin%2Fmaven-metadata.xml&label=Plugin%20Portal)
...
This project is licensed under   
 the MIT License—see the [LICENSE](LICENSE) file for   
 details.
